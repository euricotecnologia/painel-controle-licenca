...
//consulta no B.D.
$consulta = "SELECT * FROM representantes WHERE id_representante = '$id'";
$info = $con->query($consulta) or die($con->error);

//consulta no B.D.
$consulta = "SELECT * FROM sistema_representantes WHERE id_representante_fk = '$id'";
$sistemasr = $con->query($consulta) or die($con->error);

//consulta no B.D.
$consulta = "SELECT * FROM arquivo_representantes WHERE id_representante_fk = '$id'";
$arquivor = $con->query($consulta) or die($con->error);

//consulta no B.D.
$consulta = "SELECT * FROM sistemas";
$sistemas = $con->query($consulta) or die($con->error);
							...
							<div class="container-fluid">
								...
								<div class="row">
									...
									?>
										...
										<center><h1 class="display-4 text-dark"><strong>Informações Gerais do Representante</strong></h1></center><br>
									<!--end::Header-->
								...
								<div class="card card-custom gutter-b">
									...
									<div class="card-header border-0 py-1">
										...
										<div class="card-toolbar">
											<a href="../lista_cadastros/representantes.php" class="d-print-none btn btn-lg btn-warning font-weight-bolder font-size-h3"><i class="fas fa-angle-double-left icon-2x"></i>VOLTAR</a>
										</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
									...
									<?php } ?>
										...
										<div class="row justify-content-center py-3 px-8 py-md-2 px-md-0">
											<div class="col-md-12">
												<div align="right">
													...
													<a data-toggle="modal" data-target="#ModalCadastro" class="d-print-none btn btn-lg btn-success font-weight-bolder font-size-h3 mr-3"><i class="fas fa-plus icon-2x"></i>ADICIONAR SISTEMA</a>
												</div>
											...
											<table class="table table-head-custom table-vertical-center" id="tabela">
												<thead>
													<tr class="text-uppercase">
														...
														<th class="font-size-h4 pr-0 text-right" style="min-width: 60px">DELETAR</th>
													</tr>
												</thead>
												<tbody>
												    <tr>
												...
												<?php while ($dado = $sistemasr ->fetch_array()){ ?>
													<tr>
														...
														<td class="text-right pr-0">
															<a data-toggle="modal" data-target="#Modalexcluir<?php echo $dado['id_sistema_r'] ?>" class="btn btn-icon btn-light btn-hover-danger btn-lg mr-3">
										...
										<div class="row justify-content-center py-3 px-8 py-md-2 px-md-0">
											<div class="col-md-12">
												<div align="right">
													<a data-toggle="modal" data-target="#ModalArquivo" class="d-print-none btn btn-lg btn-danger font-weight-bolder font-size-h3 mr-3"><i class="fas fa-plus icon-2x"></i>ADICIONAR DOCUMENTOS <i class="fas fa-file-pdf icon-2x"></i></a>
												</div>
																...
																<div class="dropdown dropdown-inline" data-toggle="tooltip" title="AÇÕES" data-placement="left">
																	...
																	<div class="dropdown-menu dropdown-menu-md dropdown-menu-right">
																		...
																		<ul class="navi navi-hover py-5">
																			<li class="navi-item">
																				<a data-toggle="modal" data-target="#Modalexcluirarquivo<?php echo $dado['id_arquivo'] ?>" class="navi-link">
																					<span class="navi-icon">
																						<i class="flaticon-delete"></i>
																					</span>
																					<span class="navi-text">DELETAR</span>
																				</a>
																			</li>
																		</ul>
																		<!--end::Navigation-->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-success" id="exampleModalLabel">Vincular Sistema</h2>
            ...
            <div class="modal-body">
               <!--begin::Wizard Step 1-->
		<!--begin::Group-->
		<form method="POST" action="../cadastros/vincular_sistema.php">
		
		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">SELECIONE O SISTEMA</label>
				<div class="col-lg-9 col-xl-9">
					<input type="hidden" name="id" value="<?php echo $id ?>">
					<select class="form-control form-control-lg selectpicker form-control-lg" name="sistema" id="sistema" data-live-search="true" required>
									<option value="">Selecione...</option>
									<?php while ($dado = $sistemas ->fetch_array()){ ?>	
									<option value="<?php echo $dado['id_sistema'] ?>">ID: <?php echo $dado['id_sistema'] ?> - <?php echo $dado['nome_sistema'] ?></option>
									<?php } ?>
								</select>
				</div>
			</div>
		<!--end::Group-->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-lg btn-success font-weight-bold">Adicionar Sistema</button>
            </div>
            </form>
        </div>
    </div>
...
<div class="modal fade" id="ModalArquivo" data-backdrop="static" tabindex="-1" role="dialog" aria-labelledby="staticBackdrop" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-danger" id="exampleModalLabel">Adicionar Arquivo</h2>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <i aria-hidden="true" class="ki ki-close"></i>
                </button>
            </div>
            <div class="modal-body">
               <!--begin::Wizard Step 1-->
		<!--begin::Group-->
		<form method="POST" action="../cadastros/vincular_arquivo.php" enctype="multipart/form-data">
		
		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">DIGITE O NOME DO ARQUIVO</label>
				<div class="col-lg-9 col-xl-9">
					<input type="hidden" name="id" value="<?php echo $id ?>">
					<input class="form-control form-control-lg" name="arquivo" type="text" autocomplete="off" required>
				</div>
			</div>
		<!--end::Group-->
		...
		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">SELECIONE O ARQUIVO...</label>
				<div class="col-lg-9 col-xl-9">
					<input type="file" class="form-control form-control-solid form-control-lg" multiple name="arquivo[]"  required>
				</div>
			</div>
		<!--end::Group-->
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-lg btn-light-secondary text-dark font-weight-bold" data-dismiss="modal">Fechar</button>
                <button type="submit" name="enviar-formulario" class="btn btn-lg btn-danger font-weight-bold">Adicionar Sistema</button>
            </div>
            </form>
        </div>
    </div>
...
<?php while ($dado = $excluir ->fetch_array()){ ?>
		<!--begin::Modal Excluir-->
		<div class="modal fade" id="Modalexcluir<?php echo $dado['id_sistema_r'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<form method="POST" action="../deletar/excluir_sistema_representante.php">
	<input type="hidden" name="id_representante" value="<?php echo $id ?>">			
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <center>
               <h3 class="display-5 text-danger"><strong>Deseja realmente excluir <br>o sistema: <?php echo $dado['nome_sistema_r'] ?>?</strong></h3>
               <br>
               <input type="hidden" name="id" value="<?php echo $dado['id_sistema_r'] ?>">
...
<?php while ($dado = $excluir_arquivo ->fetch_array()){ ?>
		<!--begin::Modal Excluir Arquivos-->
		<div class="modal fade" id="Modalexcluirarquivo<?php echo $dado['id_arquivo'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
	<form method="POST" action="../deletar/excluir_arquivo_representante.php">
	<input type="hidden" name="id_representante" value="<?php echo $id ?>">			
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
            <center>
               <h3 class="display-5 text-danger"><strong>Deseja realmente excluir <br>o arquivo: <?php echo $dado['nome_arquivo'] ?>?</strong></h3>
               <br>
               <input type="hidden" name="id" value="<?php echo $dado['id_arquivo'] ?>">
               	<button type="submit" class="btn btn-danger h3 font-weight-bold mr-1">Excluir</button>
               	<button type="button" class="btn btn-light-secondary text-dark h3 font-weight-bold" data-dismiss="modal">Voltar</button>
               	</form>
            </center>
