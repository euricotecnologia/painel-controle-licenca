						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="card card-custom gutter-b">
									<!--begin::Header--><br>
									<center><h1 class="display-4 text-primary"><strong>RESULTADO DA PESQUISA POR CLIENTE</strong></h1></center>
								...
								<div class="card card-custom gutter-b">
									...
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label font-weight-bolder h2 text-primary">Cliente: <?php echo $dado['nome_razao'] ?></span>
