...
//consulta no B.D.
$consulta = "SELECT * FROM clientes WHERE status = '$status' AND cnpj_revenda = '".$_SESSION['cnpj_revenda']."' OR status = '$status' AND nivel_adm = (SELECT nivel_acesso FROM usuarios WHERE id_usuario = '".$_SESSION['id_usuario']."') ORDER BY data_pagamento ASC ";
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="card card-custom gutter-b">
									<!--begin::Header--><br>
									<center><h1 class="display-4 text-primary"><strong>RESULTADO DA PESQUISA POR STATUS</strong></h1></center>
								...
								<div class="card card-custom gutter-b">
									...
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											<span class="card-label font-weight-bolder h2 text-primary">Status: <?php echo $st[$status] ?></span>
										...
										<div class="table-responsive">
											<table class="table table-head-custom table-head-bg table-borderless table-vertical-center">
												...
												echo "$data[2]/$data[1]/$data[0]";?></span>
														...
														<td>
															<a data-toggle="modal" data-target="#ModalPagamento<?php echo $dado['id'] ?>" class="label label-xl label-light-<?php echo $stp_cor[$dado['status_pagamento']] ?> font-size-h3 label-inline"><?php echo $stp[$dado['status_pagamento']] ?></a>
														</td>
														<td>
