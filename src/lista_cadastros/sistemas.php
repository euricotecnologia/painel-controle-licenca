...
$consulta = "SELECT * FROM sistemas ORDER BY id_sistema DESC";
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="card card-custom gutter-b">
									<!--begin::Header--><br>
									<center><h1 class="display-4 text-success"><strong>GERENCIAMENTO DE SISTEMAS</strong></h1></center>
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											
										</h3>
										<div class="card-toolbar">
											<a data-toggle="modal" data-target="#ModalCadastro" class="btn btn-lg btn-success font-weight-bolder font-size-lg mr-3"><i class="fas fa-plus-circle icon-2x"></i>CADASTRAR SISTEMA</a>
										</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
											...
											<table class="table table-head-custom table-vertical-center" id="tabela">
												<thead>
													<tr class="text-uppercase">
														<th style="min-width: 50px">ID ÚNICO DO SISTEMA</th>
												...
												<?php while ($dado = $lista ->fetch_array()){ ?>
													<tr>
														<td>
															<span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $dado['id_unico_sistema'] ?></span>
														</td>
														<td>
														    <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $dado['nome_sistema'] ?></span>
														</td>
														<td>
															<span class="text-<?php echo $statusc[$dado['status_sistema']] ?> font-weight-bolder d-block font-size-lg"><?php echo $status[$dado['status_sistema']] ?></span>
														</td>
														<td class="text-right pr-0">
															<a data-toggle="modal" data-target="#Modaleditar<?php echo $dado['id_sistema'] ?>" class="btn btn-icon btn-light btn-hover-primary btn-lg mr-3">
															...
															<a data-toggle="modal" data-target="#Modalexcluir<?php echo $dado['id_sistema'] ?>" class="btn btn-icon btn-light btn-hover-danger btn-lg mr-3">
																<span class="svg-icon svg-icon-md svg-icon-primary">
																	<!--begin::Svg Icon | path:assets/media/svg/icons/General/Bookmark.svg-->
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-success" id="exampleModalLabel">Cadastrar Sistema</h2>
            ...
            <div class="modal-body">
               <!--begin::Wizard Step 1-->
		<!--begin::Group-->
		<form method="POST" action="../cadastros/cadastrar_sistema.php">

		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">#ID do Sistema<strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<input class="form-control form-control-lg form-control-lg" name="id" required>
							</div>
						</div>
					</div>
			    </div>
		...
		<!--begin::Group-->
			<div class="form-group row">
				<label for="sistema" class="col-xl-3 col-lg-3 col-form-label">Nome do Sistema<strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<input class="form-control form-control-lg" name="nome" placeholder="Digite o nome do sistema..." type="text" required>
							</div>
						</div>
					</div>
			    </div>
    	<!--end::Group-->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-lg btn-success font-weight-bold">Cadastrar Sistema</button>
            </div>
            </form>
        </div>
    </div>
...
<?php while ($dado = $excluir ->fetch_array()){ ?>
		<!--begin::Modal Excluir-->
		<div class="modal fade" id="Modalexcluir<?php echo $dado['id_sistema'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
			<form method="POST" action="../deletar/excluir_sistema.php">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
            <center>
               <h3 class="display-5 text-danger"><strong>Deseja realmente excluir <br>o sistema: <?php echo $dado['nome_sistema'] ?>?</strong></h3>
               <br>
               <input type="hidden" name="id" value="<?php echo $dado['id_sistema'] ?>">
...
<?php while ($dado = $editar ->fetch_array()){ ?>
		<!--begin::Modal Editar-->
		<div class="modal fade" id="Modaleditar<?php echo $dado['id_sistema'] ?>" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
            ...
            <div class="modal-body">
               <!--begin::Wizard Step 1-->
		<!--begin::Group-->
		<form method="POST" action="../editar/editar_sistema.php">
			...
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">#ID do Sistema<strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<input class="form-control form-control-lg form-control-lg" value="<?php echo $dado['id_unico_sistema'] ?>" name="id_unico" required>
							</div>
						</div>
					</div>
			    </div>
			...
			<div class="form-group row">
				<label for="sistema" class="col-xl-3 col-lg-3 col-form-label">Nome do Sistema<strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<input class="form-control form-control-lg" name="nome" value="<?php echo $dado['nome_sistema'] ?>" type="text" required>
							</div>
						</div>
					</div>
			    </div>
							...
							<label class="option">
								<span class="option-control">
									<span class="radio radio-success radio-bold radio-brand">
										<input type="radio" name="status" value="1" <?php echo $ativado[$dado['status_sistema']] ?>>
										<span></span>
									</span>
								</span>
							...
							<label class="option">
								<span class="option-control">
									<span class="radio radio-danger radio-bold radio-brand">
										<input type="radio" name="status" value="0" <?php echo $desativado[$dado['status_sistema']] ?>>
										<span></span>
									</span>
								</span>
								<span class="option-label">
        ...
        <!--end::Wizard Step 1-->
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-lg btn-light-secondary text-dark font-weight-bold" data-dismiss="modal">Fechar</button>
                <button type="submit" class="btn btn-lg btn-primary font-weight-bold">Editar Sistema</button>
            </div>
            </form>
        </div>
    </div>
