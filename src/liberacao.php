...
//consulta no B.D.
$consulta = "SELECT * FROM sistema_representantes WHERE cnpj_revenda = '".$_SESSION['cnpj_revenda']."' AND nivel_adm != (SELECT nivel_acesso FROM usuarios WHERE id_usuario = '".$_SESSION['id_usuario']."')";
...
$sistema_adm = $con->query($consulta) or die($con->error);
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="card card-custom gutter-b">
									<!--begin::Header--><br>
									<center><h1 class="display-4 text-dark"><strong>GERENCIAMENTO DE LIBERAÇÕES DE SISTEMA</strong></h1></center>
									<div class="card-header border-0 py-5">
										<h3 class="card-title align-items-start flex-column">
											
										</h3>
										<div class="card-toolbar">
											<a data-toggle="modal" data-target="#ModalCadastro" class="btn btn-lg btn-primary font-weight-bolder font-size-lg mr-3"><i class="fas fa-plus-circle icon-2x"></i>LIBERAR SISTEMA</a>
										</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
											...
											<table class="table table-head-custom table-vertical-center" id="tabela">
												<thead>
													<tr class="text-uppercase">
														<th style="min-width: 140px">NOME DO SISTEMA</th>
														<th style="min-width: 150px">CLIENTE</th>
														<th style="min-width: 150px">LIBERADO POR:</th>
														<th style="min-width: 150px">VALIDADE:</th>
														<th style="min-width: 150px">CÓDIGO DE LIBERAÇÃO:</th>
													</tr>
												</thead>
												<tbody>
												    <tr>
												...
												<?php while ($dado = $lista ->fetch_array()){ ?>
													<tr>
														<td>
														    <span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $dado['nome_sistema_fk'] ?></span>
														</td>
														<td>
															<span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $dado['nome_cliente_fk'] ?></span>
														</td>
														<td>
															<span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php echo $dado['nome_usuario_cliente_fk'] ?></span>
														</td>
														<td>
															<span class="text-dark-75 font-weight-bolder d-block font-size-lg"><?php 
												$d = explode(" ", $dado['validade_sistema']);
												$data = explode("-", $d[0]);
												echo "$data[2]/$data[1]/$data[0]" ;?></span>
														</td>
														<td>
															<span class="text-primary font-weight-bolder d-block font-size-lg">
																<strong><?php echo $dado['codigo_liberacao'] ?></strong>
															</span>
														</td>
													</tr>
												<?php } ?>	
						...
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<select class="form-control form-control-lg selectpicker form-control-lg" name="sistema" id="sistema" data-live-search="true" required>
									...
									<option value="<?php echo $dado['id_unico_sistema_r'] ?>"><?php echo $dado['nome_sistema_r'] ?></option>
									<?php } ?>
									<?php while ($dado = $sistema_adm ->fetch_array()){ ?>	
