...
//consulta no B.D.
$consulta = "SELECT * FROM liberacao_sistema ORDER BY id_liberacao DESC";
$lista = $con->query($consulta) or die($con->error);

//consulta no B.D.
$consulta = "SELECT * FROM clientes WHERE cnpj_revenda = '".$_SESSION['cnpj_revenda']."' OR nivel_adm = (SELECT nivel_acesso FROM usuarios WHERE id_usuario = '".$_SESSION['id_usuario']."')";
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="container-fluid">
								...
								<div class="card card-custom gutter-b">
									<!--begin::Header--><br>
									<center><h1 class="display-4 text-dark"><strong>CONTAS A RECEBER</strong></h1></center>
            ...
            <ul class="nav nav-tabs nav-bold nav-tabs-line">
                <li class="nav-item">
                    <a class="nav-link active" data-toggle="tab" href="#kt_tab_pane_1_4">
                        <span class="nav-icon"><i class="flaticon-calendar-2 h2"></i></span>
                        <span class="nav-text h2">Pesquisar por período</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#kt_tab_pane_2_4">
                        <span class="nav-icon"><i class="flaticon-multimedia-5 h2"></i></span>
                        <span class="nav-text h2">Pesquisar por Status</span>
                    </a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" data-toggle="tab" href="#kt_tab_pane_3_4">
                        <span class="nav-icon"><i class="flaticon-profile-1 h2"></i></span>
                        <span class="nav-text h2">Pesquisar por cliente</span>
                    </a>
                </li>
            </ul>
        </div>
    ...
    <div class="card-body">
        <div class="tab-content">
            <div class="tab-pane fade show active" id="kt_tab_pane_1_4" role="tabpanel" aria-labelledby="kt_tab_pane_1_4">
               <form method="GET" action="../pesquisas/periodo.php">
		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">Escolha o Período Inicial <strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<input class="form-control form-control-lg" name="data_inicial" type="date" required>
					</div>
				</div>
		<!--end::Group-->
		...
		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">Escolha o Período Final <strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<input class="form-control form-control-lg" name="data_final" type="date" required>
					</div>
				</div>
		<!--end::Group-->
			<div align="right">
    <button type="submit" class="btn btn-lg btn-primary font-weight-bold">Pesquisar por Período</button>
   </div> 
            </form>
            </div>
            <div class="tab-pane fade" id="kt_tab_pane_2_4" role="tabpanel" aria-labelledby="kt_tab_pane_2_4">
                <form method="GET" action="../pesquisas/status.php">
		<!--begin::Group-->
			<div class="form-group row">
				<label for="tec" class="col-xl-3 col-lg-3 col-form-label">STATUS</label>
					<div class="col-lg-9 col-xl-9">
						<select class="form-control form-control-lg selectpicker form-control-lg" name="status" id="tec" data-live-search="true" required>
							<option value="">Selecione...</option>
							<option value="0">STATUS BLOQUEADO</option>
							<option value="1">STATUS LIBERADO</option>
						</select>
					</div>
				</div>
		<!--end::Group-->
			...
			<div align="right">
    <button type="submit" class="btn btn-lg btn-primary font-weight-bold">Pesquisar por Status</button>
   </div> 
            </form>
            </div>
            <div class="tab-pane fade" id="kt_tab_pane_3_4" role="tabpanel" aria-labelledby="kt_tab_pane_3_4">
                <form method="GET" action="../pesquisas/cliente.php">
		<!--begin::Group-->
			<div class="form-group row">
				<label for="clie" class="col-xl-3 col-lg-3 col-form-label">Cliente <strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<select class="form-control form-control-lg selectpicker form-control-lg" name="cliente" id="clie" data-live-search="true" required>
							<option value="">Selecione...</option>
							<?php while ($dado = $cliente ->fetch_array()){ ?>	
							<option value="<?php echo $dado['id'] ?>">ID: <?php echo $dado['id'] ?> - <?php echo $dado['nome_fantasia'] ?> - CNPJ: <?php echo $dado['cnpj'] ?></option>
							<?php } ?>
						</select>
					</div>
				</div>
		<!--end::Group-->
			...
			<div align="right">
    <button type="submit" class="btn btn-lg btn-primary font-weight-bold">Pesquisar por Cliente</button>
   </div> 
            </form>
            </div>
        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h2 class="modal-title text-primary" id="exampleModalLabel">Liberar Sistema</h2>
            ...
            <div class="modal-body">
               <!--begin::Wizard Step 1-->
		<!--begin::Group-->
		<form method="POST" action="../cadastros/cadastrar_liberacao.php">

		<!--begin::Group-->
			<div class="form-group row">
				<label for="sistema" class="col-xl-3 col-lg-3 col-form-label"> Sistema<strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<select class="form-control form-control-lg selectpicker form-control-lg" name="sistema" id="sistema" data-live-search="true" required>
									<option value="">Selecione...</option>
									<?php while ($dado = $sistema ->fetch_array()){ ?>	
									<option value="<?php echo $dado['id_unico_sistema'] ?>"><?php echo $dado['nome_sistema'] ?></option>
									<?php } ?>
								</select>
							</div>
						</div>
		...
		<!--begin::Group-->
			<div class="form-group row">
				<label for="cliente" class="col-xl-3 col-lg-3 col-form-label"> Cliente<strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<div class="form-group row">
							<div class="col-lg-12 col-md-12 col-sm-12">
								<select class="form-control form-control-lg selectpicker form-control-lg" name="cliente" id="cliente" data-live-search="true" required>
									<option value="">Selecione...</option>
		...
		<!--begin::Group-->
			<div class="form-group row">
				<label class="col-xl-3 col-lg-3 col-form-label">Validade do sistema <strong class="text-danger">*</strong></label>
					<div class="col-lg-9 col-xl-9">
						<input class="form-control form-control-solid form-control-lg" name="validade" type="date" required>
					</div>
				</div>
		<!--end::Group-->
            ...
            <div class="modal-footer">
                ...
                <button type="submit" class="btn btn-lg btn-primary font-weight-bold">Liberar Sistema</button>
            </div>
            </form>
        </div>
    </div>
